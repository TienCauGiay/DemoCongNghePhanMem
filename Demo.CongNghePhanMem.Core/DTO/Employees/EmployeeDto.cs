using Demo.CongNghePhanMem.Core.Enums;
using System;
...
namespace Demo.CongNghePhanMem.Core.DTO.Employees
{
    /// <summary>
    ...
    public class EmployeeDto
    {
        ...
        public string? GenderName
        {
            get
            {
                switch (Gender)
                {
                    case (int?)Enums.Gender.Male: return Resources.ResourceVN.Gender_Male;
                    case (int?)Enums.Gender.Female: return Resources.ResourceVN.Gender_Female;
